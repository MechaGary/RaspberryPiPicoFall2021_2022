...
RPiPicoTempRawCounts=ADC(4)
RPiPicoTempVolts=3.3/65535
...
# Hint 3.3V = 65535 counts . In reality the resolution is still 4096 12 bits
    RPiPicoTemperature = (27 - (((RPiPicoTempRawCounts.read_u16()*RPiPicoTempVolts)-.706)/.001721))
    print (" Your room temperature is " , RPiPicoTemperature)
    utime.sleep(.2)
# The formula 27C = .706V on the ADC converter. Each degree reduces the volts by 1.721 mV 
